  ...
  return (
    <div>
      <form action={onEmail} className="mt-8 space-y-4">
        ...
        <div>
          <label htmlFor="su-name" className="block text-sm font-medium text-brand-ink mb-1.5">
            Full name
          </label>
          <input
            id="su-name"
        ...
        <div>
          <label htmlFor="su-email" className="block text-sm font-medium text-brand-ink mb-1.5">
            Email
          </label>
          <input
            id="su-email"
        ...
        <div>
          <label htmlFor="su-password" className="block text-sm font-medium text-brand-ink mb-1.5">
            Password
          </label>
          <input
            id="su-password"
        ...
        <label className="flex items-start gap-2 text-sm text-brand-ink/70">
          <input type="checkbox" required className="w-4 h-4 mt-0.5 rounded accent-brand-red" />
          <span>
            I agree to the{" "}
      ...
      <div className="space-y-3">
        <form action={onGoogle}>
          ...
          >
            ...
            {pending === "google" ? "Redirecting…" : "Sign up with Google"}
          </button>
        </form>
        ...
        <form action={onGitHub}>
          ...
          >
            ...
            {pending === "github" ? "Redirecting…" : "Sign up with GitHub"}
          </button>
        </form>
      </div>
    </div>
